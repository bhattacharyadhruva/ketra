            ...
            <div class="container">
                <div class="form-content">
                    <div class="form-title d-flex">
                        <a href="javascript:;">
                            <h2 class="mr-2 font-weight-bold" id="login-form-link">Sign In</h2>
                        </a> | <a href="javascript:;">
                            <h2 class="ml-2 text-muted" id="register-form-link">Sign Up</h2>
                        </a>
                    </div>
                    <form class="form-wrapper" action="{{ route('login') }}" id="login_form" style="display: block;"
                        method="post">
                        @csrf
