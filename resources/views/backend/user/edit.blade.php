                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" data-default-file="{{asset('storage/backend/assets/user/'.$user->photo)}}" value="{{asset('storage/backend/assets/user/'.$user->photo)}}" class="dropify" data-height="150" name="photo">
                                        </div>
                                    </div>
