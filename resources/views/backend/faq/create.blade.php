                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Question" name="question" value="{{old('question')}}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="description" class="form-control" placeholder="Write something.." rows="15" name="answer" required>{{old('answer')}}</textarea>
                                        </div>
                                    </div>
