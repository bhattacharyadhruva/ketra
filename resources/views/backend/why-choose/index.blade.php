                            ...
                            <div class="card-header">
                                <form class="mg-b-20">
                                    <div class="float-end my-1">
                                        <a href="{{route('why-choose-us.create')}}" class="btn btn-primary me-2"><i class="fe fe-plus-circle"></i> Add New</a>
                                    </div>
                                </form>
                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="g-2 d-flex">
                                                                <a href="{{route('why-choose-us.edit',$item->id)}}" class="btn text-primary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Edit"><span class="fe fe-edit fs-14"></span></a>
                                                                <form action="{{route('why-choose-us.destroy',$item->id)}}" method="post">
                                                                    @csrf
                                                                    @method('DELETE')
