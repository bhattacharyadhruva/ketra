                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <textarea id="description"  class="form-control description" placeholder="Write some meta description..." rows="20" name="privacy_policy">{{$setting->privacy_policy}}</textarea>
                                        </div>
                                    </div>
